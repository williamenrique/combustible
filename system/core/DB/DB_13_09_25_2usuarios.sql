...
-- Volcando estructura de base de datos para combuastible_db
CREATE DATABASE IF NOT EXISTS `combuastible_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `combuastible_db`;

-- Volcando estructura para tabla combuastible_db.table_departamentos
...
-- Volcando datos para la tabla combuastible_db.table_departamentos: ~3 rows (aproximadamente)
INSERT IGNORE INTO `table_departamentos` (`departamento_id`, `departamento_nombre`, `departamento_status`) VALUES
	(1, 'Sistemas', 1),
	(2, 'Ventas', 1),
	(3, 'Administración', 1);

-- Volcando estructura para tabla combuastible_db.table_menu
...
-- Volcando datos para la tabla combuastible_db.table_menu: ~5 rows (aproximadamente)
INSERT IGNORE INTO `table_menu` (`menu_id`, `menu_nombre`, `menu_icono`, `menu_tiene_submenu`, `menu_pagina`, `menu_orden`, `menu_status`, `fecha_creacion`) VALUES
	...
	(3, 'Mi Perfil', 'fas fa-user', 0, 'user/perfil', 3, 1, '2025-09-01 20:29:57'),
	(4, 'Menu', 'fas fa-list', 0, 'menu', 4, 1, '2025-09-01 20:29:57'),
	(5, 'Ayuda', 'fas fa-question-circle', 0, 'ayuda', 8, 0, '2025-09-01 20:29:57');

-- Volcando estructura para tabla combuastible_db.table_menu_submenu
...
-- Volcando datos para la tabla combuastible_db.table_menu_submenu: ~1 rows (aproximadamente)
INSERT IGNORE INTO `table_menu_submenu` (`menu_submenu_id`, `menu_id`, `submenu_id`) VALUES
	(1, 2, 1);

-- Volcando estructura para tabla combuastible_db.table_permisos_rol_menu
...
-- Volcando datos para la tabla combuastible_db.table_permisos_rol_menu: ~5 rows (aproximadamente)
...
-- Volcando estructura para tabla combuastible_db.table_roles
...
-- Volcando datos para la tabla combuastible_db.table_roles: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla combuastible_db.table_submenu
...
-- Volcando datos para la tabla combuastible_db.table_submenu: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla combuastible_db.table_usuarios
...
-- Volcando datos para la tabla combuastible_db.table_usuarios: ~2 rows (aproximadamente)
INSERT IGNORE INTO `table_usuarios` (`usuario_id`, `usuario_nick`, `usuario_password`, `usuario_nombres`, `usuario_apellidos`, `usuario_email`, `usuario_telefono`, `usuario_ci`, `usuario_rol_id`, `usuario_departamento_id`, `usuario_direccion`, `usuario_imagen`, `usuario_status`, `usuario_ruta`, `usuario_creado`) VALUES
	(1, 'admin', 'OCs4Z1hFT083MklFOU15V1NpMS9jdz09', 'Administrador', 'Sistema', 'admin@sistema.com', '123456789', '1250000', 1, 1, 'null', 'storage/ADMIN/default.png', 1, 'system/ADMIN/', '2025-09-01 01:04:19'),
	(2, 'will', 'OCs4Z1hFT083MklFOU15V1NpMS9jdz09', 'Enriquee', 'infante', 'we21@gmail.com', '4125181629', '14607920', 1, 1, 'vista alegre calle principal', 'storage/will/profile_68c21066778806.09923555.jpg', 1, 'system/WILL/', '2025-09-03 18:57:50');

-- Volcando estructura para tabla combuastible_db.table_usuario_sessions
...
-- Volcando datos para la tabla combuastible_db.table_usuario_sessions: ~0 rows (aproximadamente)
INSERT IGNORE INTO `table_usuario_sessions` (`id`, `session_id`, `usuario_id`, `ip_address`, `usuario_agent`, `created_at`, `last_activity`) VALUES
	(1, 'h2604is8begqf3f1rp3p6luuou', 2, '192.168.1.240', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36', '2025-09-13 20:37:22', '2025-09-13 20:37:22');
